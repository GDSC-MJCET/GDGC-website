  ...
  return (
    <a href={href}>
      <motion.div
        ...
        className="relative flex aspect-square items-center justify-center rounded-full bg-transparent dark:bg-gray-800">
        <AnimatePresence>
          {hovered && (
            <motion.div
              ...
              className={cn(
                "absolute left-1/2 w-fit rounded-md border border-gray-200 bg-gray-100 px-2 py-0.5 whitespace-pre text-neutral-700 dark:border-gray-900 dark:bg-gray-800 dark:text-white",
