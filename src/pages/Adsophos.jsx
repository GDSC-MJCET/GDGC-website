...
const Adsophos = () => {
  const [activePalette, setActivePalette] = React.useState(['#EA4335', '#FF00A2']);
  ...
  return (
    <div className="bg-[#1e1e1e]">
      ...
      {/* Room1 — sits directly below Hero */}
      <div id="room1-section" className="relative z-30">
        <Room1 />
      </div>

      {/* Room2 — sits below Room1 */}
      <div id="room2-section" className="relative z-30 -mt-16">
        <Room2 />
      </div>
