  ...
  const [isGuest,setIsGuest] = useState(auth.guest)
    return (
        <div className='text-[12px] flex flex-col gap-2 pl-6 pt-2'>
            ...
            <span onClick={()=>handleClickRedirect("Qr","/team/customization/qrchange" )} className={`${clicked == "Qr" ? "bg-white text-black dark:bg-neutral-800 dark:text-white rounded-md" : ""} flex flex-row  gap-2 items-center` + (isGuest ? " hidden" : "")}>
                {/* <Settings2 className='w-4'/> */}
                <Link to="/team/customization/qrchange" className={` py-1 px-3 w-full rounded-md` + (isGuest ? " hidden" : "")} >Change Qr </Link> 
                {/* <ChevronUp onClick={handleClickSetting} className='w-4'/> */}
            </span>
            <span onClick={()=>handleClickRedirect("socials","/team/customization/socials" )} className={`${clicked == "socials" ? "bg-white text-black dark:bg-neutral-800 dark:text-white rounded-md" : ""} flex flex-row gap-2 items-center`}>
                {/* <Settings2 className='w-4'/> */}
...
const AdminSubPanel = ({handleClickRedirect , clicked}) => {
    return (
        <div className='text-[12px] flex flex-col gap-2 pl-6 pt-2'>
            <span onClick={()=>handleClickRedirect("adminUsers","/team/admin/users")} className={`${clicked == "adminUsers" ? "bg-white text-black dark:bg-neutral-800 dark:text-white rounded-md" : ""} flex flex-row gap-2 items-center`}>
                <Link to="/team/admin/users" className='py-1 px-3 w-full rounded-md'>Users</Link> 
            </span>
            <span onClick={()=>handleClickRedirect("hr-interface","/team/admin/hr-interface")} className={`${clicked == "hr-interface" ? "bg-white text-black dark:bg-neutral-800 dark:text-white rounded-md" : ""} flex flex-row gap-2 items-center`}>
                <Link to="/team/admin/hr-interface" className='py-1 px-3 w-full rounded-md'>Tech Debate</Link> 
            </span>

            <p className='text-[11px] font-bold text-gray-400 uppercase tracking-widest mt-3 px-1'>Blog</p>

            <span onClick={()=>handleClickRedirect("blog-editor","/blog/editor")} className={`${clicked == "blog-editor" ? "bg-white text-black dark:bg-neutral-800 dark:text-white rounded-md" : ""} flex flex-row gap-2 items-center`}>
                <Link to="/blog/editor" className='py-1 px-3 w-full rounded-md'>Create Blog</Link>
            </span>
            <span onClick={()=>handleClickRedirect("blog-feed","/blog/home")} className={`${clicked == "blog-feed" ? "bg-white text-black dark:bg-neutral-800 dark:text-white rounded-md" : ""} flex flex-row gap-2 items-center`}>
                <Link to="/blog/home" className='py-1 px-3 w-full rounded-md'>Blog Feed</Link>
            </span>
            <span onClick={()=>handleClickRedirect("my-blogs","/blog/myblogs")} className={`${clicked == "my-blogs" ? "bg-white text-black dark:bg-neutral-800 dark:text-white rounded-md" : ""} flex flex-row gap-2 items-center`}>
                <Link to="/blog/myblogs" className='py-1 px-3 w-full rounded-md'>My Blogs</Link>
            </span>
            <span onClick={()=>handleClickRedirect("blog-help","/blog/help")} className={`${clicked == "blog-help" ? "bg-white text-black dark:bg-neutral-800 dark:text-white rounded-md" : ""} flex flex-row gap-2 items-center`}>
                <Link to="/blog/help" className='py-1 px-3 w-full rounded-md'>Help</Link>
            </span>
        </div>
    )
}
const GuestSubPanel = ({handleClickRedirect , clicked}) => {
    return (
        <div className='text-[12px] flex flex-col gap-2 pl-6 pt-2'>
            ...
            <span onClick={()=>handleClickRedirect("blog-editor","/blog/editor")} className={`${clicked == "blog-editor" ? "bg-white text-black rounded-md" : ""} flex flex-row gap-2 items-center`}>
                <Link to="/blog/editor" className='py-1 px-3 w-full rounded-md'>Create Blog</Link>
            </span>
            <span onClick={()=>handleClickRedirect("blog-feed","/blog/home")} className={`${clicked == "blog-feed" ? "bg-white text-black rounded-md" : ""} flex flex-row gap-2 items-center`}>
                <Link to="/blog/home" className='py-1 px-3 w-full rounded-md'>Blog Feed</Link>
            </span>
            <span onClick={()=>handleClickRedirect("my-blogs","/blog/myblogs")} className={`${clicked == "my-blogs" ? "bg-white text-black rounded-md" : ""} flex flex-row gap-2 items-center`}>
                <Link to="/blog/myblogs" className='py-1 px-3 w-full rounded-md'>My Blogs</Link>
            </span>
            <span onClick={()=>handleClickRedirect("blog-help","/blog/help")} className={`${clicked == "blog-help" ? "bg-white text-black rounded-md" : ""} flex flex-row gap-2 items-center`}>
                <Link to="/blog/help" className='py-1 px-3 w-full rounded-md'>Help</Link>
            </span>
        </div>
    )
...
const SuperAdminSubPanel = ({handleClickRedirect , clicked}) => {
    return (
        <div className='text-[12px] flex flex-col gap-2 pl-6 pt-2'>
            <span onClick={()=>handleClickRedirect("superAdminDashboard","/team/superadmin" )} className={`${clicked == "superAdminDashboard" ? "bg-white text-black dark:bg-neutral-800 dark:text-white rounded-md" : ""} flex flex-row gap-2 items-center`}>
                <Link to="/team/superadmin" className=' py-1 px-3 w-full rounded-md' >Dashboard</Link> 
            </span>
            <span onClick={()=>handleClickRedirect("superAdminUsers","/team/superadmin/users" )} className={`${clicked == "superAdminUsers" ? "bg-white text-black dark:bg-neutral-800 dark:text-white rounded-md" : ""} flex flex-row gap-2 items-center`}>
            ...
            <span onClick={()=>handleClickRedirect("superAdminContacts","/team/superadmin/contacts" )} className={`${clicked == "superAdminContacts" ? "bg-white text-black rounded-md" : ""} flex flex-row gap-2 items-center`}>
                ...
                <Link to="/blog/superadmin-validation" className=' py-1 px-3 w-full rounded-md' >Validate Blogs</Link> 
        ...
        <div className='flex flex-col text-[13px] p-5 gap-3'>
          ...
          <div>
            <span onClick={handleClickSettings} className='flex p-2 flex-row text-[13px] gap-3 items-center rounded-md cursor-pointer hover:bg-gray-800'>
              ...
              {openSettingPanel ? <ChevronDown className='w-4 h-4 text-gray-400'/> : <ChevronUp className='w-4 h-4 text-gray-400'/>}
            </span>
            {!openSettingPanel && <GuestSubPanel handleClickRedirect={handleClickRedirect} clicked={clicked} />}
          </div>
        </div>
      </div>
    </>
