...
const About = () => {
  ...
  const textX = useTransform(smoothProgress, [0, 1], [100, -600]);
  ...
  const imgY4 = useTransform(smoothProgress, [0, 1], [110, -200]);
  const imgY5 = useTransform(smoothProgress, [0, 1], [0, -280]);

  return (
    <section
      ref={sectionRef}
      className="relative max-h-screen md:min-h-[110vh] overflow-hidden px-4 sm:px-6 lg:px-8"
    >
      <motion.h2
        style={{ x: textX }}
        className="
