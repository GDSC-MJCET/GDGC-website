        ...
        <div className='py-16 sm:py-20 md:py-24 lg:py-28 xl:py-32 space-y-16 sm:space-y-20 md:space-y-24 lg:space-y-28 xl:space-y-32 flex flex-col justify-center items-center gap-6 sm:gap-8 md:gap-10 lg:gap-12'>
            <div className="flex flex-col md:flex-row gap-6 sm:gap-8 md:gap-12 lg:gap-16 xl:gap-24 items-start w-full max-w-7xl px-4">
                ...
                >
                    ...
                    <p className="text-md sm:text-md md:text-xl opacity-90">
             ...
             <div
                ...
                >
                    ...
                    <p className="text-md sm:text-sm opacity-90 md:text-xl">
                        <span className='mb-5'>What’s Being Debated ?</span>
                        <br></br>
                        <br></br>
                        From emerging technologies to ethical dilemmas in engineering, Tech Face-Off brings forward topics that demand clarity, logic, and informed technical reasoning.
